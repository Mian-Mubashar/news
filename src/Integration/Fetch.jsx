...
const Fetch = () => {
  ...
  const fetchData = () => {
    ...
    fetch(
      "https://newsapi.org/v2/everything?q=tesla&from=2024-11-30&sortBy=publishedAt&apiKey=74d83fc6076945f9b7fbe3210217c34a"
    )
      .then((res) => res.json())
      .then((res) => {
        if (res.articles) {
  ...
  return (
    <>
      ...
      <div className="p-4">
        ...
        <h1 className="text-2xl font-bold mb-4">Tesla News</h1>
        <button
          onClick={fetchData}
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {displayedData.map((article, index) => (
              <div className="bg-orange-400 border-2 rounded-lg p-4" key={index}>
                <img
